...
class Hello extends Component {
    ...
    handleclick() {
        axios.get("https://spotfire.azurewebsites.net/api/GetSite?").then(res => { this.setState({ ...this.state, data: res.data }) })
    }
    ...
    {this.state.data.length ? <div id='SITE'style={{fontStyle:'Fantasy'}}><h4 > Site Name : {this.state.data[this.state.currentIndex].name}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Site Location : {this.state.data[this.state.currentIndex].location}</h4></div> : null}
     ...
     <div>
        <div class="button1">
                <button style={{float: "left",marginLeft:100,borderRadius:10}} type='text' onClick={() => this.setState({ ...this.state, currentIndex: this.state.currentIndex - 1 })}> previous Site</button>
                {/* &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; */}
            </div>
            
            <div class="button2">
                <button style={{float: "right",borderRadius:10}} type='text' onClick={() => this.setState({ ...this.state, currentIndex: this.state.currentIndex + 1 })}> Next Site </button>
            </div>
        </div>      
            ...
            <Row style={{marginTop: '60px'}}>
                ...
                <Col xs={{ span: 11, offset: 1 }} lg={{ span: 6, offset: 2 }}>
                    ...
                    IP Address : <br/>
                    RAM Address : <br/>
                    Ram Usage :  {this.state.raM_Usage} <br/>
                    </Card>
                </Col>
                <Col xs={{ span: 5, offset: 1 }} lg={{ span: 6, offset: 2 }}>
                    ...
                    Maintance Alert :  {this.state.maintainence_alert} <br/>
                    Real Time Alert :  <br/>
                    Trouble Count :  {this.state.trouble_count} <br/>
                    </Card>
                </Col>
            </Row>
            ...
            <div class="button1">
                <button style={{float: "left",marginTop: 15,marginLeft:100,borderRadius:10}}> previous Device</button>
                
            </div>
            
            <div class="button2">
                <button style={{float: "right",marginTop: 15,borderRadius:10}} > Next Device </button>
            </div>
